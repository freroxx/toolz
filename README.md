...
Toolz currently targets Android 12 and above, ships from this repository as version `1.0.8`, and combines 30+ precision instruments into a single Compose-first experience. Many tools work locally on-device, while connected features like AI, web search, music catalog downloads, and update checks use the internet when needed.
