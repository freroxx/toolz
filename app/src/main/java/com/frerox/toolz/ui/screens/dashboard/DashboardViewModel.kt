            ...
            base.map { cat ->
                cat.copy(
                    items = cat.items.filter { item ->
                        ...
                        item.route != Screen.Search.homeRoute &&
    ...
    fun getDashboardCategories() = listOf(
        ToolCategory(
            ...
            listOf(
                ...
                ToolItem(com.frerox.toolz.R.string.st_Tool_Search, Icons.Rounded.Search, Screen.Search.homeRoute, com.frerox.toolz.R.string.st_Tool_Search_Desc, Color(0xFF3F51B5)),
        ...
        ToolCategory(
            ...
            listOf(
                ...
                ToolItem(com.frerox.toolz.R.string.st_Tool_MediaDownloader, Icons.Rounded.CloudDownload, Screen.MediaDownloader.homeRoute, com.frerox.toolz.R.string.st_Tool_MediaDownloader_Desc, Color(0xFF00ACC1)),
