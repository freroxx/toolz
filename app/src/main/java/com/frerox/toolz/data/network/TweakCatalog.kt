...
object TweakCatalog {
    ...
    val tweaks: List<WifiTweak> = listOf(
        ...
        WifiTweak(
            ...
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.STABILITY,
            applyCommands = listOf("cmd wifi set-wifi-verbose-logging-enabled true || true"),
            revertCommands = listOf("cmd wifi set-wifi-verbose-logging-enabled false || true"),
        ...
        WifiTweak(
            id = "private_dns_cloudflare_family",
            title = "Private DNS: Cloudflare Family",
            description = "Blocks malware + adult content via family.cloudflare-dns.com.",
            icon = Icons.Rounded.Shield,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec family.cloudflare-dns.com"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"family.cloudflare-dns.com\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter family.cloudflare-dns.com.")
        ),
        WifiTweak(
            id = "private_dns_adguard_family",
            title = "Private DNS: AdGuard Family",
            description = "Ad/tracker blocking + adult filter via family.adguard-dns.com.",
            icon = Icons.Rounded.Shield,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec family.adguard-dns.com"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"family.adguard-dns.com\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter family.adguard-dns.com.")
        ),
        WifiTweak(
            id = "private_dns_nextdns",
            title = "Private DNS: NextDNS",
            description = "Custom filtering via dns.nextdns.io — replace with your ID for personal rules.",
            icon = Icons.Rounded.Public,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec dns.nextdns.io"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"dns.nextdns.io\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter dns.nextdns.io (or your NextDNS ID).")
        ),
        WifiTweak(
            id = "private_dns_quad9_unsecured",
            title = "Private DNS: Quad9 Unfiltered",
            description = "No blocking — pure privacy via dns10.quad9.net.",
            icon = Icons.Rounded.Public,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec dns10.quad9.net"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"dns10.quad9.net\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter dns10.quad9.net.")
        ),
        WifiTweak(
            id = "private_dns_mullvad",
            title = "Private DNS: Mullvad",
            description = "Minimal-logging via dns.mullvad.net.",
            icon = Icons.Rounded.GppGood,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec dns.mullvad.net"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"dns.mullvad.net\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter dns.mullvad.net.")
        ),
        WifiTweak(
            id = "private_dns_cleanbrowsing",
            title = "Private DNS: CleanBrowsing",
            description = "Family/security filter via security-filter-dns.cleanbrowsing.org.",
            icon = Icons.Rounded.Shield,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec security-filter-dns.cleanbrowsing.org"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"security-filter-dns.cleanbrowsing.org\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter security-filter-dns.cleanbrowsing.org.")
        ),
        WifiTweak(
            id = "private_dns_opendns",
            title = "Private DNS: OpenDNS",
            description = "Cisco OpenDNS via doh.opendns.com.",
            icon = Icons.Rounded.Public,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec doh.opendns.com"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"doh.opendns.com\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter doh.opendns.com.")
        ),
        WifiTweak(
            id = "private_dns_controld",
            title = "Private DNS: Control D",
            description = "Flexible profiles via freedns.controld.com.",
            icon = Icons.Rounded.Public,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec freedns.controld.com"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"freedns.controld.com\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter freedns.controld.com.")
        ),
        WifiTweak(
            id = "private_dns_dns_sb",
            title = "Private DNS: DNS.SB",
            description = "Non-profit no-log via dot.sb.",
            icon = Icons.Rounded.GppGood,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec dot.sb"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"dot.sb\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter dot.sb.")
        ),
        WifiTweak(
            id = "private_dns_yandex",
            title = "Private DNS: Yandex",
            description = "Fast EU/Asia via common.dot.dns.yandex.net.",
            icon = Icons.Rounded.Public,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec common.dot.dns.yandex.net"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"common.dot.dns.yandex.net\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter common.dot.dns.yandex.net.")
        ),
        WifiTweak(
            id = "private_dns_opendns_family",
            title = "Private DNS: OpenDNS Family",
            description = "FamilyShield via doh.familyshield.opendns.com.",
            icon = Icons.Rounded.Shield,
            type = TweakType.SHIZUKU_OR_GUIDE,
            category = TweakCategory.PRIVACY,
            applyCommands = listOf("settings put global private_dns_mode hostname", "settings put global private_dns_spec doh.familyshield.opendns.com"),
            revertCommands = listOf("settings put global private_dns_mode opportunistic", "settings delete global private_dns_spec"),
            verificationCommand = "[ \"\$(settings get global private_dns_mode)\" = \"hostname\" ] && [ \"\$(settings get global private_dns_spec)\" = \"doh.familyshield.opendns.com\" ]",
            manualSteps = listOf("Open Network and internet settings.", "Tap Private DNS.", "Choose Private DNS provider hostname.", "Enter doh.familyshield.opendns.com.")
        ),
        WifiTweak(
