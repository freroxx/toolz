...
data class EngineCapabilities(
    ...
    val supportsNews: Boolean = true,
    val supportsVideos: Boolean = true,
    val supportsSafeSearch: Boolean = true,
    val safeSearchParam: String = ""
)

val EngineCapabilitiesMatrix: Map<EngineId, EngineCapabilities> = mapOf(
    EngineId.DUCKDUCKGO to EngineCapabilities(supportsImages = true, supportsNews = true, supportsVideos = true),
    ...
    EngineId.ECOSIA to EngineCapabilities(),
    EngineId.SWISSCOWS to EngineCapabilities(supportsImages = false, supportsNews = false, supportsVideos = false),
    EngineId.STARTPAGE to EngineCapabilities(supportsImages = false, supportsNews = false, supportsVideos = false),
